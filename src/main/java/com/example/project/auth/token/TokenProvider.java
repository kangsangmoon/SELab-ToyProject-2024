...
import com.example.project.auth.application.AuthService;
...
public class TokenProvider {
    ...
    public boolean validateDateToken(String jwtToken) {
        try {
            ...
            throw new com.example.project.error.exception.user.ExpiredJwtException(ErrorMessage.EXPIRED_JWT_EXCEPTION, "토큰이 만료되었습니다");
        } catch (io.jsonwebtoken.JwtException e) {
            throw new com.example.project.error.exception.user.JwtException(ErrorMessage.WRONG_JWT_EXCEPTION, "잘못된 토큰 정보입니다");
        }
    }
}